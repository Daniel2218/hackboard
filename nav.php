    ...
    <body>
        <div id = "nav">
            ...
            <ul>
                ...
                <li><a href="#"> <i class="fa fa-file-pdf-o" aria-hidden="true"></i> <span>Schedule</span></a> </li>
                <li><a href="#"> <i class="fa fa-file-pdf-o" aria-hidden="true"></i> <span>Teams</span></a> </li>
            </ul>
        </div>
